...
<div style="background-color:#ffffff;">
	...
	<a href="<?php echo base_url('auth.cc'); ?>" style="text-decoration:none;">
	...
	<div id="description" style="margin-top:5px;color:#8e8e93;font-size:9pt;">Aduh kaka belum masuk ya? masuk dulu gih pake fesbuk. biar bisa ngobrol.. B-)</div>
	</div>
