  ...
  function search(){
  	...
  	if(texx!=""){
		...
		$.getJSON("<?php echo base_url('tanya.cc?txt='); ?>" + texx, function(result) {
  		...
  		$('#tah').append('<tr><td class="bot" style="position:relative"><div class="img-jones6" style="margin-left:5px;"></div><div style="float:left;"><div class="left-convo">' + result.respon+ '</div></td></tr>');
...
<div class="img-jones6" style="margin-left:5px;"></div>
<div style="float:left;">
<div class="left-convo" ><?php echo $psn_robot6;?></div>
</td>
</tr>
