  ...
  function search(){
  	...
  	if(texx!=""){
		...
		$.getJSON("<?php echo base_url('tanya.cc?txt='); ?>" + texx, function(result) {
  		...
  		$('#tah').append('<tr><td class="bot" style="position:relative"><div class="img-jones2" style="margin-left:5px;"></div><div style="float:left;"><div class="left-convo">' + result.respon+ '</div></td></tr>');
...
<a href="<?php echo base_url('ruang_obrolan.cc');?>" target="_top">
<span id="backward" class="backward"></span></a>
<b><?php echo "Cie lagi ngobrol sama ".$jones.".";?></b>
<a href="<?php echo base_url('ruang_obrolan.cc');?>" target="_top">
<span id="backward" class="backward"></span></a>
</div>
</div>
...
<div id="msgs" class="contents_wrap" style="overflow-y:auto;width:100%px;height:63%;padding:10px; background:url('<?php echo base_url('asset/gambar/talk_bg.png');?>');min-height:265px">

<table class="new-templete" id="tah">
<tr>
<td class="bot" style="position:relative">
<div class="img-jones2" style="margin-left:5px;"></div>
<div style="float:left;">
<div class="left-convo" ><?php echo $psn_robot2;?></div>
</td>
</tr>
...
<input type="text" name="txt" id="pesan" placeholder="Ayo ngobrol!" class="form-control">
