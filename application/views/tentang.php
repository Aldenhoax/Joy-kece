...
$(document).ready(function(){
  function search(){
  	...
  	if(texx!=""){
  		...
  		$("#loading").show();
		$.getJSON("<?php echo base_url('tentang/tanya.cc?txt='); ?>" + texx, function(result) {
  		$('#tah').append('<tr align="right"><td class="jelema" style="position:relative"><div class="img-jelema" style="margin-right:5px;"></div><div style="float:right;"><div class="right-convo">' + result.no+ '</div></td></tr>');
...
<b><?php echo $nama_situs;?> - Tentang</b>
</div>
</div>
</div>
...
<div class="left-convo" >Tentang <?php echo $nama_situs;?><br><br>
Silahkan tanya <br>tanya tentang web<br> ini :D<br>
<br>Ini List Nanyanya :<br>
1. Siapa Pembuatnya?<br>
2. Punya ide dari mana?<br>
3. Minta facebook <br> sama twitter <br> authornya dong. :)<br><br>
...
<input type="text" name="txt" id="pesan" placeholder="ketik '0' untuk bantuan" class="form-control">
...
<div id="tentang-li_highlight">
<a id="tentang-btn" class="btn" href="<?php echo base_url('tentang.cc');?>" ><div id="img_tentang_aktif"></div>Tentang</a>
</div>
</div>
