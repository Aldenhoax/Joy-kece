...
<div class="left-convo" >Selamat datang di Website <a href="<?php echo base_url(); ?>"><?php echo $nama_situs;?></a> :)<br>
Silahkan <a href="<?php echo base_url('auth.cc'); ?>">masuk</a> ke <br>hati aku kak sambil <br>ngobrol sama 
<br><?php echo $nama_admin; ?> :*
</div>
